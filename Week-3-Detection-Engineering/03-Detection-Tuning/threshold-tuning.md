...
Yes, if the threshold is low, normal people can trigger is as well. For example. If the threshold for a physical password guessing attack is 10 attempts per minutes, a person who is in a hurry, or drunk, or not in his sense, or a child just pressing random keys on a keyboard can trigger it. 
